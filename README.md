...
| The tests would actually notice a defect | — | [`docs/MUTATION-TESTING.md`](docs/MUTATION-TESTING.md) — **65.0%** mutation score over the detectors and the backtest split, with all 157 surviving mutants listed rather than summarised, and the 4 remaining gaps named |
...
docs/       adr/      7 decision records, each with the rejected alternative
            ...
            MUTATION-TESTING.md (65.0% measured, every survivor judged)
